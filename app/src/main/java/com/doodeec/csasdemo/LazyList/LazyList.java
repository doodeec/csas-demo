...
import com.doodeec.csasdemo.AppState;
...
public class LazyList<T> extends android.support.v4.app.ListFragment {
    ...
    protected com.doodeec.csasdemo.LazyList.LazyListAdapter mAdapter;
    ...
    protected void initAdapter() {
        mAdapter = new com.doodeec.csasdemo.LazyList.LazyListAdapter<T>(mData, LazyList.this);
    }
    ...
    protected synchronized void onDataLoadingFailed(int reason, final Integer page) {
        ...
        switch (reason) {
            case REASON_LIST_END:
                Toast.makeText(AppState.getContext(), R.string.list_end, Toast.LENGTH_SHORT).show();
                mBlockLazyLoad = true;
                break;
            case REASON_SERVER_ERROR:
                Toast.makeText(AppState.getContext(), R.string.server_error_msg, Toast.LENGTH_SHORT).show();
                break;
            case REASON_CONNECTION_LOST:
                break;
            default:
                Toast.makeText(AppState.getContext(), R.string.unknown_error, Toast.LENGTH_SHORT).show();
                //TODO throw error?
                break;
        }
